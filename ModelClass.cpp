...
void ModelClass::Render(ID3D11DeviceContext* deviceContext, TextureShaderClass* texShader, XMMATRIX* world, XMMATRIX* view, XMMATRIX* projection, XMFLOAT3* lightColor, XMFLOAT3* lightDir)
{
...
int ModelClass::GetIndexCount(int index)
{
...
void ModelClass::InitMesh(unsigned int Index, const aiMesh* pMesh, ID3D11Device* device)
{
...
bool ModelClass::InitMaterials(const aiScene* pScene, const std::string& Filename, ID3D11Device* device, ID3D11DeviceContext* context)
{
...
void ModelClass::RenderBuffers(ID3D11DeviceContext* deviceContext, TextureShaderClass* texShader, XMMATRIX* world, XMMATRIX* view, XMMATRIX* projection, XMFLOAT3* lightColor, XMFLOAT3* lightDir)
{
	unsigned int stride;
	unsigned int offset;
...
{
	std::map<string, TextureClass>::iterator it;
